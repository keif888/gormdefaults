...
func TestExampleV2(t *testing.T) {
	...
	t.Run("CreateNonDefaults", func(t *testing.T) {
		...
		// INSERT INTO `itemv2` (`name_no_default`,`name_blank_default`,`name_text_default`,`name_db_default`,`in_stock_no_default`,`in_stock_zero_default`,`in_stock_number_default`,`in_stock_db_default`,`created_at`,`updated_at`,`deleted_at`) VALUES ("Test Record 1 CreateNonDefaults","","NaN","",1771,0,-1,0,"2026-06-19 22:00:44.85","2026-06-19 22:00:44.85",NULL) RETURNING `id`
	...
	t.Run("CreateNonDefaultsOmitDBDefaults", func(t *testing.T) {
		...
		// INSERT INTO `itemv2` (`name_no_default`,`name_blank_default`,`name_text_default`,`in_stock_no_default`,`in_stock_zero_default`,`in_stock_number_default`,`created_at`,`updated_at`,`deleted_at`) VALUES ("Test Record 2 CreateNonDefaultsOmitDBDefaults","","NaN",1772,0,-1,"2026-06-19 22:00:44.854","2026-06-19 22:00:44.854",NULL) RETURNING `id`
		if !assert.NoError(t, dbV2.Omit("name_db_default", "in_stock_db_default").Create(&r2).Error) {
			...
			r2 = Itemv2{ID: r2.ID}
			// SELECT * FROM `itemv2` WHERE `itemv2`.`id` = 2 ORDER BY `itemv2`.`id` LIMIT 1
	...
	t.Run("SaveAllToZero", func(t *testing.T) {
		...
		// INSERT INTO `itemv2` (`name_no_default`,`name_blank_default`,`name_text_default`,`name_db_default`,`in_stock_no_default`,`in_stock_zero_default`,`in_stock_number_default`,`in_stock_db_default`,`created_at`,`updated_at`,`deleted_at`) VALUES ("Test Record 3 SaveAllToZero","Test Record 3 SaveAllToZero","Test Record 3 SaveAllToZero","Test Record 3 SaveAllToZero",1773,1773,1773,1773,"2026-06-19 22:00:44.858","2026-06-19 22:00:44.858",NULL) RETURNING `id`
		if !assert.NoError(t, dbV2.Create(&r3).Error) {
			...
			// UPDATE `itemv2` SET `name_no_default`="",`name_blank_default`="",`name_text_default`="",`name_db_default`="",`in_stock_no_default`=0,`in_stock_zero_default`=0,`in_stock_number_default`=0,`in_stock_db_default`=0,`created_at`="2026-06-19 22:00:44.858",`updated_at`="2026-06-19 22:00:44.86",`deleted_at`=NULL WHERE `id` = 3
			assert.NoError(t, r3.Save())
			// Reload just in case
			r3 = Itemv2{ID: r3.ID}
			// SELECT * FROM `itemv2` WHERE `itemv2`.`id` = 3 ORDER BY `itemv2`.`id` LIMIT 1
	...
	t.Run("UpdatesAllToZero", func(t *testing.T) {
		...
		// INSERT INTO `itemv2` (`name_no_default`,`name_blank_default`,`name_text_default`,`name_db_default`,`in_stock_no_default`,`in_stock_zero_default`,`in_stock_number_default`,`in_stock_db_default`,`created_at`,`updated_at`,`deleted_at`) VALUES ("Test Record 4 UpdatesAllToZero","Test Record 4 UpdatesAllToZero","Test Record 4 UpdatesAllToZero","Test Record 4 UpdatesAllToZero",1774,1774,1774,1774,"2026-06-19 22:00:44.862","2026-06-19 22:00:44.862",NULL) RETURNING `id`
		if !assert.NoError(t, dbV2.Create(&r4).Error) {
			...
			// UPDATE `itemv2` SET `id`=4,`created_at`="2026-06-19 22:00:44.862",`updated_at`="2026-06-19 22:00:44.867" WHERE `id` = 4
			assert.NoError(t, dbV2.Model(&Itemv2{ID: r4.ID}).Updates(&r4).Error)
			// Reload just in case
			r4 = Itemv2{ID: r4.ID}
			// SELECT * FROM `itemv2` WHERE `itemv2`.`id` = 4 ORDER BY `itemv2`.`id` LIMIT 1
	...
	t.Run("UpdateColumnsAllToZero", func(t *testing.T) {
		...
		// INSERT INTO `itemv2` (`name_no_default`,`name_blank_default`,`name_text_default`,`name_db_default`,`in_stock_no_default`,`in_stock_zero_default`,`in_stock_number_default`,`in_stock_db_default`,`created_at`,`updated_at`,`deleted_at`) VALUES ("Test Record 5 UpdateColumnsAllToZero","Test Record 5 UpdateColumnsAllToZero","Test Record 5 UpdateColumnsAllToZero","Test Record 5 UpdateColumnsAllToZero",1775,1775,1775,1775,"2026-06-19 22:00:44.869","2026-06-19 22:00:44.869",NULL) RETURNING `id`
		if !assert.NoError(t, dbV2.Create(&r5).Error) {
			...
			// UPDATE `itemv2` SET `id`=5,`created_at`="2026-06-19 22:00:44.869",`updated_at`="2026-06-19 22:00:44.869" WHERE `id` = 5
			assert.NoError(t, dbV2.Model(&Itemv2{ID: r5.ID}).UpdateColumns(&r5).Error)
			// Reload just in case
			r5 = Itemv2{ID: r5.ID}
			// SELECT * FROM `itemv2` WHERE `itemv2`.`id` = 5 ORDER BY `itemv2`.`id` LIMIT 1
	...
	t.Run("UpdatesAllToZeroMap", func(t *testing.T) {
		...
		// INSERT INTO `itemv2` (`name_no_default`,`name_blank_default`,`name_text_default`,`name_db_default`,`in_stock_no_default`,`in_stock_zero_default`,`in_stock_number_default`,`in_stock_db_default`,`created_at`,`updated_at`,`deleted_at`) VALUES ("Test Record 6 UpdatesAllToZeroMap","Test Record 6 UpdatesAllToZeroMap","Test Record 6 UpdatesAllToZeroMap","Test Record 6 UpdatesAllToZeroMap",1776,1776,1776,1776,"2026-06-19 22:00:44.874","2026-06-19 22:00:44.874",NULL) RETURNING `id`
		if !assert.NoError(t, dbV2.Create(&r6).Error) {
			...
			// UPDATE `itemv2` SET `in_stock_db_default`=0,`in_stock_no_default`=0,`in_stock_number_default`=0,`in_stock_zero_default`=0,`name_blank_default`="",`name_db_default`="",`name_no_default`="",`name_text_default`="",`updated_at`="2026-06-19 22:00:44.877" WHERE `id` = 6
			...
			// Reload just in case
			r6 = Itemv2{ID: r6.ID}
			// SELECT * FROM `itemv2` WHERE `itemv2`.`id` = 6 ORDER BY `itemv2`.`id` LIMIT 1
	...
	t.Run("UpdateColumnsAllToZeroMap", func(t *testing.T) {
		...
		// INSERT INTO `itemv2` (`name_no_default`,`name_blank_default`,`name_text_default`,`name_db_default`,`in_stock_no_default`,`in_stock_zero_default`,`in_stock_number_default`,`in_stock_db_default`,`created_at`,`updated_at`,`deleted_at`) VALUES ("Test Record 7 UpdateColumnsAllToZeroMap","Test Record 7 UpdateColumnsAllToZeroMap","Test Record 7 UpdateColumnsAllToZeroMap","Test Record 7 UpdateColumnsAllToZeroMap",1777,1777,1777,1777,"2026-06-19 22:00:44.88","2026-06-19 22:00:44.88",NULL) RETURNING `id`
		if !assert.NoError(t, dbV2.Create(&r7).Error) {
			...
			// UPDATE `itemv2` SET `in_stock_db_default`=0,`in_stock_no_default`=0,`in_stock_number_default`=0,`in_stock_zero_default`=0,`name_blank_default`="",`name_db_default`="",`name_no_default`="",`name_text_default`="" WHERE `id` = 7
			...
			// Reload just in case
			r7 = Itemv2{ID: r7.ID}
			// SELECT * FROM `itemv2` WHERE `itemv2`.`id` = 7 ORDER BY `itemv2`.`id` LIMIT 1
	...
	t.Run("SaveAllWithZeroThenZeroAgain", func(t *testing.T) {
		...
		// INSERT INTO `itemv2` (`name_no_default`,`name_blank_default`,`name_text_default`,`name_db_default`,`in_stock_no_default`,`in_stock_zero_default`,`in_stock_number_default`,`in_stock_db_default`,`created_at`,`updated_at`,`deleted_at`) VALUES ("","","NaN","",0,0,-1,0,"2026-06-19 22:00:44.887","2026-06-19 22:00:44.887",NULL) RETURNING `id`
		if !assert.NoError(t, dbV2.Save(&r8).Error) {
			...
			// UPDATE `itemv2` SET `name_no_default`="",`name_blank_default`="",`name_text_default`="",`name_db_default`="",`in_stock_no_default`=0,`in_stock_zero_default`=0,`in_stock_number_default`=0,`in_stock_db_default`=0,`created_at`="2026-06-19 22:00:44.887",`updated_at`="2026-06-19 22:00:44.891",`deleted_at`=NULL WHERE `id` = 8
			assert.NoError(t, r8.Save())
			// Reload just in case
			r8 = Itemv2{ID: r8.ID}
			// SELECT * FROM `itemv2` WHERE `itemv2`.`id` = 8 ORDER BY `itemv2`.`id` LIMIT 1
	...
	t.Run("CreateAllWithZero", func(t *testing.T) {
		...
		// INSERT INTO `itemv2` (`name_no_default`,`name_blank_default`,`name_text_default`,`name_db_default`,`in_stock_no_default`,`in_stock_zero_default`,`in_stock_number_default`,`in_stock_db_default`,`created_at`,`updated_at`,`deleted_at`) VALUES ("","","NaN","",0,0,-1,0,"2026-06-19 23:01:58.608","2026-06-19 23:01:58.608",NULL) RETURNING `id`
